...
| `/securities/:symbol` | one security                           | **a price chart** — that security's real minute bars over the default five sessions, drawn, with a crosshair and a keyboard reading, the exact figures beneath it, and the feed labelled; plus §8.3's other six regions, five of which name the epic that fills them (Stories 2.13, Epic 3, Epics 5, 8, 9) |
