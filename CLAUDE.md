...
apps/
  ...
  frontend/                        @marketpulse/frontend — React + Vite (Story 1.3)
    ...
    src/App.tsx                    the router's host since Task 1.5.2:
                                   BrowserRouter, the five Routes, and the
                                   temporary navigation strip. Not a page
