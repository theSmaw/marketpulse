...
What they still cannot do: see the states other than an answer drawn as states (2.12.7), see volume, change the time window (2.13), or watch a price move — there is still no live data, and the four remaining regions are empty on purpose.
