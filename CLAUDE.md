...
| **How a live observation reaches this process** — the seam, the three implementations, the two clocks, and what a green stream suite does not certify | [`STREAM-SEAM.md`](planning/epic-03-live-market-data/story-02-stream-seam-and-alpaca-iex-client/STREAM-SEAM.md) — the vendor is `LIVE-DATA.md`'s; this is our client's |
