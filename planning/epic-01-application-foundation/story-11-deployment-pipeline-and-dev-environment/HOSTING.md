...
**The reversal trigger is Task 2.1.4**, the first thing here that opens a connection. On that day the line becomes a `✗` and the `e2e` job in `.github/workflows/verify.yml` gains a service.
