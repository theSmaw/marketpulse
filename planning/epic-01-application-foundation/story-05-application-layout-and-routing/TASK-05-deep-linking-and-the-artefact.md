...
- Re-measure the artefact at the end of this task — modules, JS, CSS, file count — against **three** figures now, so the router's cost, the routes' cost and this task's stay separately attributable rather than arriving as one number: the Story 1.4 baseline of 193 / 300.09 kB / 7.21 kB / 3, Task 1.5.1's router spike at 253 / 337.82 kB, and **Task 1.5.2's shipped 261 / 340.10 kB / 8.62 kB / 3**, which is the one to diff against
