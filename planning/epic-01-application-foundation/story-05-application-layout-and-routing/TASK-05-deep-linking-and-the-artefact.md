...
- Re-measure the artefact at the end of this task — modules, JS, CSS, file count — against the 193 / 300.09 kB / 7.21 kB / 3 baseline, so the router's and the routes' cost is attributable
