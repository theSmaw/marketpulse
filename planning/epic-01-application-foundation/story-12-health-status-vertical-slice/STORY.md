...
- **This story is still the first stateful code in the tree** unless Story 1.5 gets there first. Story 1.4 added five components and the React Compiler rules never fired, because CSS Modules compute nothing during render. A polling effect is exactly what they were adopted for
